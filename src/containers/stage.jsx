...
import { getSubsectionList, setShowVideo } from '../reducers/other';
...
class Stage extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (
            ...
            this.props.subsectionList !== nextProps.subsectionList ||
            this.props.curSubsection !== nextProps.curSubsection ||
            this.props.showVideo !== nextProps.showVideo
        );
    }
