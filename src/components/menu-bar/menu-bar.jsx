...
import profileIcon from './userLogo.png';
            ...
            <Box className={classNames(this.props.className, styles.menuBar)}>
                <div className={styles.mainMenu}>
                    ...
                    <div className={classNames(styles.subjectSelectBox)}>
                        <div
                            className={classNames(styles.subjectSelect)}
                            onClick={() => {
                        ...
                        >
                            <div>
                                ...
                                <span
                                    ...
                                    title={curSubsection && curSubsection.name}
                                >
                                    {curSubsection && curSubsection.name}
                                </span>
                            </div>
                            <img
                                className={styles.languageCaret}
                                    ...
                                    subsectionList.map(item => {
                                        return (
                                            <MenuItem
                                                key={item.id}
                                                classNameOther={
                                                    styles.subjectSelectList
                                                }
                                                onClick={() => {
                                                    changeCurSubsection(item);
                                                    this.setState({
                                                        subjectMenu: false,
                                                    });
                                                    if (
